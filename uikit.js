    ...
    if (youtube || vimeo) {
      return (this.ready = new Promise(function(resolve) {
        ...
        listen(function(data$$1) {
          return (
            (youtube && data$$1.id === this$1.id && data$$1.event === "onReady") ||
  ...
  */
    ...
    events: [
...

      {
        ...
        handler: function(ref) {
          ...
          if (this.$el !== target) {
            active =
              active === null && within(target, this.$el) && this.isToggled() ? this : active;
            return;
          }
              ...
              translates[i] = row.map(function(_, j) {
                return i === 0
                  ...
                  : toFloat(translates[i - 1][j]) +
                      (height$$1 - toFloat(rows[i - 1][j] && rows[i - 1][j].offsetHeight));
              });
  ...
  var Leader = {
    ...
    connected: function() {
      ...
      (assign$$1 = wrapInner(this.$el, '<span class="' + this.clsWrapper + '">')),
  ...
  var Switcher = {
    ...
    update: function() {
      ...
      this.show(
        filter(this.toggles, "." + this.cls)[0] || this.toggles[this.active] || this.toggles[0]
      );
    },
  ...
  function matchFilter(el, attr$$1, ref) {
    ...
    return (
      (isUndefined(filter$$1) || (group in stateFilter && filter$$1 === stateFilter[group])) &&
  ...
  var Animations$1 = assign({}, Animations, {
    ...
    scale: {
      show: function() {
        return [{ opacity: 0, transform: scale3d(1 - 0.2) }, { opacity: 1, transform: scale3d(1) }];
      },
          ...
          if (type === "image" || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
            ...
            var setIframe = function(width$$1, height$$1) {
              ...
              return this$1.setItem(
                item,
                getIframe(
                  "https://www.youtube" + (matches$$1[1] || "") + ".com/embed/" + id,
                  width$$1,
                  height$$1,
          ...
          this.$create(
            ...
            assign({}, this.$props, {
              items: this.toggles.reduce(function(items, el) {
                items.push(
                  ["href", "caption", "type", "poster", "alt"].reduce(function(obj, attr$$1) {
      ...
      getActives: function() {
        ...
        return sortBy(
          slides(list).filter(function(slide) {
            ...
            return (
              slideLeft >= left && slideLeft + bounds(slide).width <= bounds(list).width + left
            );
          }),
          "offsetLeft"
        );
      ...
      reorder: function() {
        ...
        this.slides.forEach(function(slide, i) {
          return css(
            slide,
            "order",
            this$1.dir > 0 && i < index$$1 ? 1 : this$1.dir < 0 && i >= this$1.index ? -1 : ""
          );
        });
  ...
  var Animations$2 = assign({}, Animations, {
    ...
    pull: {
      show: function(dir) {
        return dir < 0
          ? [{ transform: translate(30), zIndex: -1 }, { transform: translate(), zIndex: 0 }]
          : [{ transform: translate(-100), zIndex: 0 }, { transform: translate(), zIndex: -1 }];
      },
